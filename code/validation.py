...
def test_single_case(net, image, stride, patch_size, num_classes=1):
    ...
    sz = math.ceil((dd - patch_size[2]) / stride[1]) + 1
...
def test_single_case_resize(net, image, stride, patch_size, num_classes=1):
    w, h, d = image.shape
...
def test_all_case(net, base_dir, test_list="full_test.list", num_classes=4, patch_size=(48, 160, 160), stride=[8, 48, 48]):
    ...
    for image_path in tqdm(image_list):
        ...
        prediction = test_single_case(
            net, image, stride, patch_size, num_classes=num_classes)
